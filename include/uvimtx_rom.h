...
typedef struct UvImtx_Rom_Exports_s {
    ...
    /* 0x04 */ void (*func_uvimtx_rom_00400250)(Mtx*, Mtx);             /* inferred */
    /* 0x08 */ void (*func_uvimtx_rom_004002D8)(Mtx*);                  /* inferred */
    /* 0x0C */ void (*func_uvimtx_rom_00400324)(s32, s32, s32, s32);    /* inferred */
    /* 0x10 */ void (*func_uvimtx_rom_00400338)(uvMtx*, uvMtx);        /* inferred */
    /* 0x14 */ void (*func_uvimtx_rom_00400410)(Mtx);                  /* inferred */
    /* 0x18 */ void (*func_uvimtx_rom_0040048C)();                     /* inferred */
    /* 0x1C */ void (*func_uvimtx_rom_004004D8)(Mtx);                  /* inferred */
    /* 0x20 */ Mtx* (*func_uvimtx_rom_00400554)(Mtx, u16);             /* inferred */
